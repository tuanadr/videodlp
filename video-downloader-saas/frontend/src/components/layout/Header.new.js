...
const Header = () => {
  ...
  const navigation = [
    ...
    { name: 'Trang hỗ trợ', href: '/supported-sites', current: location.pathname === '/supported-sites' },
  ];

  const downloaderLinks = [
    { name: 'YouTube', href: '/tai-video-youtube', icon: '🎥' },
    { name: 'TikTok', href: '/tai-video-tiktok', icon: '🎵' },
    { name: 'Facebook', href: '/tai-video-facebook', icon: '📘' },
    { name: 'Instagram', href: '/tai-video-instagram', icon: '📷' },
    { name: 'SoundCloud', href: '/tai-nhac-soundcloud', icon: '🎧' },
  ];
